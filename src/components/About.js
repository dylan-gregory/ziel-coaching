    ...
    return (
      <div className="container">
        <div className="about-z">
          ...
          <div>
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;I am not a business coach, nor am I a counselor. What I am is a master of habit change. And often times, our own habits, developed over years of negative experience, discouragement, and disappointment keep us from seeing forward movement in our lives. The goal of Ziel Coaching is to identify those habits, discover which ones are helpful and which could be harmful, and then align those that serve you with your true identity, using encouragement, optimism and accountability as a guide.
          </div>
          <div>
